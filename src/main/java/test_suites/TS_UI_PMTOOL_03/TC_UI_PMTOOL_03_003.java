...
public class TC_UI_PMTOOL_03_003 extends BaseTest {
    @Test
    public void TC_UI_PMTOOL_03_003_Delete_Project() {
        ...
        page.log("4. Create new project")
                ...
                .log("6. Delete the created project")
                .deleteProject()
                .log("7. Verify that the project has been deleted")
