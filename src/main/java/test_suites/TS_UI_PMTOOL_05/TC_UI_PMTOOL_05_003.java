...
public class TC_UI_PMTOOL_05_003 extends BaseTest {
    @Test
    public void TC_UI_PMTOOL_05_002_Search_Task() {
        ...
        page.log("15. Navigate to TaskDB page and sort the tasks.")
                .viewAllTasks()
                .navigateToTaskDB();
        page.log("16. Search task for all fields and check")
                .searchTask()
                .searchForTask(getTestCaseData(1));
    }
}
