...
public class TC_UI_PMTOOL_05_001 extends BaseTest {
    @Test
    public void TC_UI_PMTOOL_05_001_View_All_Tasks() {
        ...
        page.log("15. Navigate to TaskDB page and verify that all tasks appears.")
                .viewAllTasks()
                .navigateToTaskDB();
        page.viewAllTasks()
                .verifyAllTasksPresent(getTestCaseData(1), getTestCaseData(2), getTestCaseData(3));
    }
}
